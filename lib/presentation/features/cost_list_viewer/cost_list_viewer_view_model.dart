...
final homeViewModelProvider = StateNotifierProvider.autoDispose<
        CostListViewerViewModel, AsyncValue<CostListViewerState>>(
    (ref) => CostListViewerViewModel(
        ref.read(costRepositoryProvider), ref.read(sayingRepositoryProvider)));

class CostListViewerViewModel
    extends StateNotifier<AsyncValue<CostListViewerState>> {
