...
/// @nodoc
mixin _$Tags {
  List<Tag> get value => throw _privateConstructorUsedError;
...
class _$_Tags implements _Tags {
  _$_Tags({required final List<Tag> value})
...
abstract class _Tags implements Tags {
  factory _Tags({required final List<Tag> value}) = _$_Tags;
